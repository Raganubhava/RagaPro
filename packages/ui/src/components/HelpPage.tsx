  ...
  return (
    <>
      <PageContainer>
        ...
        >
          <H2 fontFamily="$heading" color="$primary" alignSelf="center" $sm={{ fontSize: '$7', textAlign: 'center' }}>
            Explore the World of Indian Classical Ragas
          </H2>

          <H3 fontFamily="$heading" color="$primary" textAlign="center" $sm={{ fontSize: '$5' }}>
          ...
          <H3 fontFamily="$heading" color="$primary" $sm={{ fontSize: '$5' }}>
          ...
          <Paragraph color="$textSecondary" lineHeight={26}>
            Ragavai ananta - ragas are infinite in Carnatic music. Although the system defines 72 Melakarta ragas, the number of Janya ragas is vast because ragas evolve over time. Some ragas become popular in certain eras, while others fade and reappear later in history. This natural fluidity makes the world of Carnatic ragas dynamic and ever-changing, giving the tradition an infinite melodic scope.
          </Paragraph>
