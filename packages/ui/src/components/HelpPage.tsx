    ...
    <PageContainer>
      ...
      >
        ...
        <Paragraph color="$textSecondary" lineHeight={26}>
          ...
          emotional qualities, and the cultural stories that make each raga unique. RagaPro honors the profound spiritual heritage of Indian classical music — as described in
          Hamsadhwani — including the power of <strong>Nada</strong>, the significance of OM, and the transformative journey of melody.
        </Paragraph>
